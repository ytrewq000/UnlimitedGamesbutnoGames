...
Silks.prototype.inputFrame = function() {
  ...
  if (this.pinputX != null) {
    if (this.inputIsActive) {
      this.addPoint(this.activeSilkId, this.inputX, this.inputY, 
                    this.inputX - this.pinputX, this.inputY - this.pinputY);
    } else if ((_ref1 = this.inputPreviewSilk) != null) {
      _ref1.addPoint(this.inputX, this.inputY, 
                     this.inputX - this.pinputX, this.inputY - this.pinputY);
    }
  }
